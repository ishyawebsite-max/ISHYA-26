        ...
        <div id="ishya-floating-nav-wrapper">
            ...
            <nav class="ishya-nav-container" id="ishyaHeader">
                ...
                <div class="ishya-menu-grid">
                    ...
                    <!-- MODIFIED: Added Results Link, temporary shift to script link redirection -->
                    ...
                    <a href="https://script.google.com/macros/s/AKfycbzIB-obPI64aIBAjyZA3X8kMiugCKw0CMaQsahayU2Q7qeU1VhnlrXJ8_uzgx2W4raS/exec" class="ishya-link"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg><span>Results</span></a>
